...
public class ThetaDataOpenInterestConverter : JsonConverter<OpenInterestResponse>
{
    /// <summary>
    ...
    /// <param name="serializer">The calling serializer.</param>
    public override void WriteJson(JsonWriter writer, OpenInterestResponse value, JsonSerializer serializer)
    {
